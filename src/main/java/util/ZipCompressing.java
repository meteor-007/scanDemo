...
public class ZipCompressing {
    ...
    static String filePath = "D:\\数据库漏洞扫描\\sql\\";//需要压缩的文件夹完整路径
    static String fileName = "sql";//需要压缩的文件夹名
    static String outPath = "D:\\数据库漏洞扫描\\sql\\VSlib20190304_001.zip";//压缩完成后保存为Test.zip文件，名字随意
