...
//
///**
// * @description: excel表格写入到数据库表中
// * @author: czwei
// * @create: 2019-01-14 21:01
// */
...
//    }
//
//    private static void makeExcel(List<List<String>> result) {
...
//    }
//
//    private static List<List<String>> dealData(List<List<String>> allData) {
//        //结果
...
//     * @date: 2019/1/14
//     */
//    private static List<List<String>> readExcel(File file) throws FileNotFoundException {
//
//        // 创建输入流，读取Excel
