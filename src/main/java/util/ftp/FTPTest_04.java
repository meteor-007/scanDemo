...
//            logger.info("下载文件夹失败");
    ...
    public static void main(String[] args) throws IOException {
        FTPTest_04 ftp=new FTPTest_04("172.23.1.20",21,"czwei","Czw0927");
        ftp.ftpLogin();
        System.out.println("1");
        //上传文件夹
        boolean uploadFlag = ftp.uploadDirectory("D:\\数据库漏洞扫描\\1", "/"); //如果是admin/那么传的就是所有文件，如果只是/那么就是传文件夹
        System.out.println("uploadFlag : " + uploadFlag);
        //下载文件夹
        boolean uploadFlag1 = ftp.downLoadDirectory("D:\\数据库漏洞扫描\\1", "/");
        System.out.println("uploadFlag : " + uploadFlag1);
        ftp.ftpLogOut();
